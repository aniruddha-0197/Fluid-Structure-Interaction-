...
figure(3)
hold off;
loglog(vec_N(:,1),err_vec_Df_NN ,'r-x','LineWidth',2.0);
hold on;
loglog(vec_N(:,1),err_vec_Df_RBF,'g-x','LineWidth',2.0);
legend('NN','RBF');
...
figure(4)
hold off;
loglog(vec_N(:,1),err_vec_Ps_NN(:,1) ,'r-x','LineWidth',2.0);
hold on;
loglog(vec_N(:,1),err_vec_Ps_RBF(:,1),'g-x','LineWidth',2.0);
loglog(vec_N(:,1),err_vec_Ps_NN(:,2) ,'r--o','LineWidth',2.0);
loglog(vec_N(:,1),err_vec_Ps_RBF(:,2),'g--o','LineWidth',2.0);
...
figure(5)
hold off;
loglog(vec_N(:,1),err_vec_dW_NN(:,1) ,'r-x','LineWidth',2.0);
hold on;
loglog(vec_N(:,1),err_vec_dW_RBF(:,1),'g-x','LineWidth',2.0);
loglog(vec_N(:,1),err_vec_dW_NN(:,2) ,'r--o','LineWidth',2.0);
loglog(vec_N(:,1),err_vec_dW_RBF(:,2),'g--o','LineWidth',2.0);
legend('NN','RBF','NN - conservative','RBF - conservative')
xlabel('Number of structure elements')
